                        ...
                        <h3 class="mt-4">Réinitialisation du mot de passe</h2>
                            @if(isset($status)&& $status == 'success')
                                <div class="row  d-flex justify-content-center">
                                    <h5 class="mt-2">Lien de récupération du mot de passe envoyé</h5>
                                    <div class="mt-2">
                                        <div class="checkout-form">
                                            <!-- Form -->
                                                <p>Veuillez verifier votre boite email pour le lien de réinitialisation</p>
                                                <p>Cliquez sur le lien pour définir un nouveau mot de passe</p>
                                                {{-- <p>Si vous n'avez pas recüvez le lien de définir un nouveau mot de passe</p>
                                                </a> --}}
                                        </div>
                                    </div>
                                </div>
                            @else
                                <div class="row  d-flex justify-content-center">
                                    <h5 class="mt-2">Imposible de recuperer le mot de passe</h5>
                                    <div class="mt-2">
                                        <div class="checkout-form">
                                            <!-- Form -->
                                                <p>Aucun compte ne correspond à cet email</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
