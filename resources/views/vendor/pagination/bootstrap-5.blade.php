    ...
    <nav class="d-flex justify-content-center">
        <div class="d-flex ">
            ...
            @if ($paginator->onFirstPage())
                <li class="btn_two page-item disabled" aria-disabled="true">
                    <span class="">@lang('pagination.previous')</span>
                </li>
            @else
                <li class=" btn_one page-item">
            ...
            @if ($paginator->hasMorePages())
                <li class="page-item btn_one">
                    <a class="" href="{{ $paginator->nextPageUrl() }}" rel="next">@lang('pagination.next')</a>
                </li>
            @else
                <li class="page-item btn_two disabled" aria-disabled="true">
