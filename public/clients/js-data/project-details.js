                            ...
                            onComplete: function(reason) {
                              //  console.log(reason);
                               if(reason?.reason === "CHECKOUT COMPLETE"){
                                    $.ajax({
                                        url: '/pay/project/finish', // Remplacez par l'URL cible de votre requête
                                        type: 'POST',
                                        data: {
                                            id: response.data.id,
                                ...
                                $.ajax({
                                    url: '/pay/project/confirme', // Remplacez par l'URL cible de votre requête
                                    type: 'POST',
                                    data: {
                                        pay_id:response.data.id,
                                        id: response.data.id,
